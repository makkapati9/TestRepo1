	...
	<div class="login-one">
		...
		<div class="lb-close-btn" onclick="closeIt();"></div>
			<div class="login-head">
				...
				<form  name="contactUs" id="contactUs" method="post" class="formAx">
					...
					<input type="text" id="receiverName" name="receiverName" class="text" value="${map.dat1[0][1]}" />
									<p>Message<lable> *</lable></p>
				<textarea rows="2" id="message" name="message" class="textA"
									 maxlength="500" >${map.dat1[0][4]}</textarea>
				 <p>Mobile No <lable></lable></p>
					...
					<input type="button" onclick="contact();" value="Save" ></div>
		</form>
		<div class="clear"> </div>
		</div>
	</div>
